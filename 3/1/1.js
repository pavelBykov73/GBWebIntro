...
*/
var userName;
userName = parseInt(prompt("Введите температуру в градусах Цельсия:"))
var gradFarengeit = (9 / 5) * userName + 32;
alert(`Цельсий: ${userName}  Фаренгейт: ${gradFarengeit.toFixed(1)}`);
//alert("Цельсий: " + gradCels + " Фаренгейт: " + gradFarengeit.toFixed(1));